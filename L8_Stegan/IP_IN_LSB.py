...
if __name__ == "__main__":
    hidden_message = "TARGET:192.168.1.50"
    print("Testing hide message in company_logo.png with LSB ...")
    print(hide_message('company_logo.png', hidden_message, 'company_logo_stego.png'))
    print("Hide test passed, testing message extraction ...")
    print(extract_message('company_logo_stego.png'))
